...
class GameObject:
    def __init__(self, position:Vector2, sprite:surface.Surface, velocity:Vector2):
        self.position:Vector2 = Vector2(position)
        self.sprite:surface.Surface = sprite
    ...
    def move(self, surface:surface.Surface):
...
class Asteroid(GameObject):
    def __init__(self, position:Vector2, create_asteroid_callback:Callable[[Any],None], size:int=3):
